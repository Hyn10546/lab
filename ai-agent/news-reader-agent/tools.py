...
def scrape_tool(url:str):
    ...
    Input should be a 'url' string. for example (https://en.wikipedia.org/wiki/Cambodian%E2%80%93Thai_border_dispute)
    """
    ...
    with sync_playwright() as p:
        ...
        # HTML을 markup으로 parser는 html.parser로 지정
